...
#ifndef NSX_MPU6050_H
#define NSX_MPU6050_H
 ...
 * @return uint32_t status
 */
uint32_t mpu6050_set_gyro_full_scale(mpu6050_context_t *ctx, mpu6050_gyro_fs_t fsr);
 ...
 */
uint32_t
mpu6050_get_gyro_values(mpu6050_context_t *ctx, int16_t *x, int16_t *y, int16_t *z);
 ...
 * @return uint32_t status
 */
uint32_t mpu6050_set_accel_offset(mpu6050_context_t *ctx, uint8_t axis, int offset);
...
uint32_t mpu6050_init(
    mpu6050_context_t *ctx, nsx_i2c_config_t *i2c_config, const mpu6050_config_t *config,
    uint32_t dev_addr);
